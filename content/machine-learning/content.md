...
::: .exercise
**Exercise**  
Experiment with the sliders below to minimize the loss value of the regression. 
:::

{.text-center} `β_0 =`${β_0}{β_0|-1|-10,0,.25}

{.text-center} `β_1 =`${β_1}{β_1|1|0,10,.25}
    
{.text-center} `β_2 =`${β_2}{β_2|0|-10,10,0.25}

{.text-center} loss = ${loss}

    x-coordinate-system(width=600 height=400 x-axis="0,8,0.5" y-axis="0,25,1")
...
::: .exercise
**Exercise**  
It may be better to classify observations using a quadratic decision boundary rather than a linear one. Use the sliders below to create a boundary for the following data set.
:::

{.text-center} `β_0 =`${β_0}{β_0|-1|-10,10,.25}

{.text-center} `β_1 =`${β_1}{β_1|1|-10,10,.25}
    
{.text-center} `β_2 =`${β_2}{β_2|0|-10,10,0.25}

    x-coordinate-system(width=600 height=400 x-axis="0,5,0.5" y-axis="0,10,1")
...
---
> id: likelihood-ratio-exercise

::: .exercise
**Exercise**  
Experiment with the sliders below. 
:::

{.text-center} `t =`${t}{t|0|-20,20,1}

{.text-center} `mu =`${mu}{mu|0|.25,4,.25}

    x-coordinate-system(width=600 height=400 x-axis="0,1,0.1" y-axis="0,1,0.1")
...
---
> id: svm-animation-exercise

::: .exercise
**Exercise**  
Experiment with the sliders below to minimize the loss value of the support vector machine. Use lambda to oberve 
how the optimal margin changes, ie it behaves more like a hard margin as lambda increases.  
:::

{.text-center} `wi =`${wi}{wi|-1|-10,0,.25}

{.text-center} `wj =`${wj}{wj|1|0,10,.25}
    
{.text-center} `b =`${b}{b|0|-10,10,0.25}

{.text-center} `lambda =`${lambda}{lambda|0|0,10,0.25}

{.text-center} loss = ${loss}

    x-coordinate-system(width=600 height=400 x-axis="0,8,0.5" y-axis="0,10,1")
...
---
> id: dimension-reduction-exercise

::: .exercise
**Exercise**  
Observe how $P\_{2,1}$ changes with $\sigma$.
:::

{.text-center} `sigma =`${sigma}{sigma|.25|.25,100,.25}

{.text-center} $P\_{2,1}$ = ${value}
